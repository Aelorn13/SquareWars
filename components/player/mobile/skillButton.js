// components/player/mobile/skillButton.js
...
export function createSkillButton({
  ...
  label.textContent = "★"; // Using a star icon for the skill
  ...
  function applyStyles() {
    ...
    label.style.fontSize = `${Math.round(sizePx * 0.55)}px`; // Adjusted for star icon
  }
